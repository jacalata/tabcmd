...
class UserDataTest(unittest.TestCase):
    ...
    def test_get_users_from_file(self):
        ...
        assert user_data.get_users_from_file(test_content) is not None
    ...
    def test_get_user_detail_standard(self):
        ...
        test_user = user_data.get_user_detail(test_line)
    ...
    def test_evaluate_role(self):
        for input in UserDataTest.role_inputs:
            actual = user_data.evaluate_user_role(input[0], input[1], input[2])
